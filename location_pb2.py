...
_RESPONSE_RESPONSEWIFI_WIFILOCATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="latitude",
            full_name="Response.ResponseWifi.WifiLocation.latitude",
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="longitude",
            full_name="Response.ResponseWifi.WifiLocation.longitude",
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="accuracy",
            full_name="Response.ResponseWifi.WifiLocation.accuracy",
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="zeroField4",
            full_name="Response.ResponseWifi.WifiLocation.zeroField4",
            index=3,
            number=4,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="altitude",
            full_name="Response.ResponseWifi.WifiLocation.altitude",
            index=4,
            number=5,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="Response.ResponseWifi.WifiLocation.altitudeAccuracy",
            index=5,
            number=6,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="unknown11",
            full_name="Response.ResponseWifi.WifiLocation.unknown11",
            index=6,
            number=11,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="unknown12",
            full_name="Response.ResponseWifi.WifiLocation.unknown12",
            index=7,
            number=12,
            type=5,
            cpp_type=1,
...
_RESPONSE_RESPONSEWIFI = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="mac",
            full_name="Response.ResponseWifi.mac",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="location",
            full_name="Response.ResponseWifi.location",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="channel",
            full_name="Response.ResponseWifi.channel",
            index=2,
            number=21,
            type=5,
            cpp_type=1,
    ...
    extensions=[],
    nested_types=[
        _RESPONSE_RESPONSEWIFI_WIFILOCATION,
    ],
    enum_types=[],
    options=None,
    is_extendable=False,
...
_RESPONSE_RESPONSEWIFI.fields_by_name[
    "location"
].message_type = _RESPONSE_RESPONSEWIFI_WIFILOCATION
...
Response = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    dict(
        ResponseWifi=_reflection.GeneratedProtocolMessageType(
            "ResponseWifi",
            (_message.Message,),
            dict(
                WifiLocation=_reflection.GeneratedProtocolMessageType(
                    "WifiLocation",
                    (_message.Message,),
                    dict(
